...
$sql = "SELECT * FROM locais WHERE tipo_evento = 'acampamento'";
...
<html lang="en">
<head>
    <title>Locais de Acampamento</title>
    <link rel="icon" href="../img/app/icon.png" type="image/x-icon">
    <link rel="stylesheet" type="text/css" href="css/acampamento.css">
</head>
<body>
    <h1>Locais de Acampamentos</h1>
    <ul>
        <?php
