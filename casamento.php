...
$sql = "SELECT * FROM locais WHERE tipo_evento = 'casamento'";
...
<html lang="en">
<head>
    <title>Locais de Casamento</title>
    <link rel="icon" href="../img/app/icon.png" type="image/x-icon">
    <link rel="stylesheet" type="text/css" href="css/casamento.css">
</head>
<body>
    <h1>Locais de Casamento</h1>
    <ul>
        <?php
